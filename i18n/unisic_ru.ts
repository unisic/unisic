...
<context>
    ...
    <message>
        ...
        <translation>В этой сборке нет поддержки libinput, поэтому нажатия клавиш определить нельзя.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Найден - запись экрана и экспорт в GIF доступны.</translation>
    </message>
    <message>
        ...
        <translation>Отсутствует. Записи экрана и экспорту в GIF нужен FFmpeg. Установите пакет «ffmpeg».</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Найден - копирование в буфер обмена работает максимально надёжно.</translation>
    </message>
    <message>
        ...
        <translation>Необязательно. Установите «wl-clipboard» для самого надёжного копирования в буфер обмена в Wayland.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Необязательно. Установите пакет Tesseract «osd», чтобы автоопределение языка OCR работало с разными письменностями.</translation>
    </message>
    <message>
        <location filename="../src/AppContext.cpp" line="2307"/>
        <source>Dev: keystroke badge: %1</source>
        <translation>Dev: значок нажатия клавиш: %1</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Dev: проверка системы: проверок %1, отсутствует %2 (из них основных %3)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>В этой сборке нет поддержки libinput, поэтому щелчки мышью определить нельзя.</translation>
    </message>
    <message>
    ...
    <message numerus="yes">
        ...
        <translation>
            ...
            <numerusform>Добавлено %n сочетания для %1</numerusform>
            <numerusform>Добавлено %n сочетаний для %1</numerusform>
        </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>sftp://host/path/  или  ftp://host/path/</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подстановки: $base64$, $filename$, $mime$</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Откуда доступен отправленный файл. Без него отправка через curl проходит, но ссылку скопировать не из чего.</translation>
    </message>
    <message>
...
<context>
    ...
    <message numerus="yes">
        ...
        <translation>
            ...
            <numerusform>Скрыто %n совпадения</numerusform>
            <numerusform>Скрыто %n совпадений</numerusform>
        </translation>
    </message>
</context>
<context>
...
Starred (favorite) captures are kept, both the entry and the file.</source>
        <translation>Это удалит все записи истории И переместит файлы снимков в корзину.
...
Starred (favorite) captures in the selection are kept - un-star them first.</source>
        <translation>Это переместит выбранные файлы снимков в корзину.
...
<context>
    ...
    <message>
        ...
        <translation>Качество (CRF %1, меньше - лучше)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Формат файла для сохранённых снимков: PNG, JPEG или WebP.</translation>
    </message>
    <message>
        ...
        <translation>PNG без потерь и самый большой; JPEG и WebP меньше, с настраиваемым качеством. Формат также применяется при отправке и, где это уместно, к изображению в буфере обмена.</translation>
    </message>
    <message>
        <location filename="../qml/pages/SettingsPage.qml" line="2017"/>
        <source>Quality (JPEG/WebP): %1</source>
        <translation>Качество (JPEG/WebP): %1</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Больше - лучше точность и больше файл. PNG эту настройку не учитывает, так как он всегда без потерь.</translation>
    </message>
    <message>
...
Applies to the next capture.</source>
        <translation>Обычная: полная карточка с большой миниатюрой, заголовком и рядом кнопок действий.
Компактная: более плотная карточка со средней миниатюрой, именем файла и теми же действиями.
Маленькая: одна узкая строка с крошечными значками действий.
Минимальная: плашка только с именем файла; щелчок по ней открывает плавающий предпросмотр.
Миниатюра: сначала изображение, снимок заполняет карточку, а действия появляются при наведении.
...
Применяется к следующему снимку.</translation>
    ...
    <message>
        ...
        <translation>Посмотрите, какие необязательные инструменты (FFmpeg, wl-clipboard, языковые пакеты OCR) установлены.</translation>
    </message>
    <message>
        ...
        <translation>Unisic работает на одних лишь встроенных API Wayland; эти внешние инструменты необязательны и добавляют запись, самое надёжное копирование в буфер обмена и распознавание текста. Проверка перечисляет, что уже есть, и как установить остальное.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Использует устройство ввода по умолчанию. Смешивается с системным звуком, если включены оба. В GIF звука нет.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Unisic работает сразу. Эти необязательные инструменты добавляют возможности - установите те, которых не хватает.</translation>
    </message>
    <message>
