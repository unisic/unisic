...
class Settings : public QObject
{
    ...
    Q_PROPERTY(QString hotkeyPreviewPassthrough READ hotkeyPreviewPassthrough WRITE setHotkeyPreviewPassthrough NOTIFY hotkeyPreviewPassthroughChanged)
...
public:
    ...
    U_SETTING(QString, hotkeyPreviewPassthrough, setHotkeyPreviewPassthrough, "hotkeys/previewPassthrough", QStringLiteral("Meta+Shift+P"))
    ...
    void notifyAll()
    {
        ...
        emit hotkeyPreviewPassthroughChanged();
...
signals:
    ...
    void hotkeyPreviewPassthroughChanged();
